...
- Compliant relays: relays that attempt to maximize fees paid to the block proposer, but filter out and censor any transactions destined to or coming from an OFAC blacklisted address.
